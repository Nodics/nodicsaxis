  ...
  record3: {
    ...
    properties: {
      ...
      source: {
        ...
        hash: 'a18228099fbe23e9ba0232ccd06a4e0cf01325a1b51b2c4a56bbb87303cae704',
        version: '0.3.15',
      },
      previous: {
        title: 'Architecture and Repository Boundaries',
  ...
  record9: {
    ...
    properties: {
      ...
      source: {
        ...
        hash: '5d1a3d23be0ff014d52e00fe463ac8f866529730ac4ffa7462e04ccc49ee7014',
        version: '0.3.15',
      },
      previous: {
        title: 'Axis Assistant Frontend',
  ...
  record12: {
    ...
    properties: {
      ...
      blocks: [
        ...
        {
          kind: 'paragraph',
          text: 'The same section also supports governed upload. The employee selects an upload purpose, such as data imports, content media, product media, or utility media. Axis first asks nMedia for backend-owned media source contexts through `/contexts`. The context response tells Axis which source types are eligible for manual upload, which folders and formats they use, and which route template can be shown to the employee. If an older backend does not publish contexts, Axis falls back to the older `/storage/policy` folder probes. Data exports are not shown as a manual-upload source type by default because export files are generated by the Exports workspace. When the employee uploads a file, Axis posts multipart data to the nMedia `/storage/upload` endpoint. nMedia validates the folder, file type, size, checksum, provider, and storage key. Axis receives the returned media code and refreshes the media list. Axis does not choose the filesystem folder, does not generate the storage key, and does not persist media metadata directly.',
        },
        {
          kind: 'paragraph',
        ...
        },
        {
          ...
          items: [
            ...
            'Axis displays only the safe context and policy metadata.',
        ...
        },
        {
          ...
          items: [
            ...
            'Storage policy inspection uses nMedia `/contexts` first and falls back to `/storage/policy` only for older backend deployments. It does not call storage-location or upload APIs unless that workflow is explicitly being executed.',
      ...
      source: {
        ...
        hash: '9e36e9c942840a4ffa2cf7cdc19ebaaffd62717c26c7b5e38c43ce01fdb31f02',
        version: '0.3.15',
      },
      previous: {
        title: 'Imports and Exports Workspace',
