  ...
  record11: {
    ...
    properties: {
      ...
      headings: [
        ...
        {
          text: 'Customize and extend safely',
          anchor: 'imports-exports-6-customize-and-extend-safely',
          level: 2,
        },
      ],
      blocks: [
        ...
        {
          kind: 'paragraph',
          text: 'The screen has four deliberate states:',
        },
        {
          kind: 'ordered-list',
          items: [
            ...
            '**Upload governed file.** The chosen browser file is submitted as `multipart/form-data` to nMedia. Axis never sets the multipart boundary by hand; the browser owns that header.',
      ...
      source: {
        ...
        hash: 'f735998c62b3c94dd8b168d85e364ba1f8d2fa921d487a5a8e3494d42c83041a',
        version: '0.3.15',
      },
      previous: {
        title: 'Module Health',
